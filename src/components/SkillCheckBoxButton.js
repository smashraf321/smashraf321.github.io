...
<li> */}
<div class="flex">
  <input type="checkbox" id="choose-me1" class="hidden peer" />
  <label for="choose-me1" class="select-none cursor-pointer rounded-lg border-2 border-gray-200
   py-3 px-6 font-bold text-gray-200 transition-colors duration-200 ease-in-out peer-checked:bg-gray-200 peer-checked:text-gray-900 peer-checked:border-gray-200 "> Check me1 </label>
</div>
{/* </li>
<li> */}
<div class="flex">
  <input type="checkbox" id="choose-me2" class="hidden peer" />
  <label for="choose-me2" class="select-none cursor-pointer rounded-lg border-2 border-gray-200
   py-3 px-6 font-bold text-gray-200 transition-colors duration-200 ease-in-out peer-checked:bg-gray-200 peer-checked:text-gray-900 peer-checked:border-gray-200 "> Check me2 </label>
</div>
{/* </li>
</ul> */}
...
<div class="flex">
{/* <div> */}
  <input type="checkbox" id="choose-me3" class="hidden peer" />
  <label for="choose-me3" class="select-none cursor-pointer rounded-lg border-2 border-gray-200
   py-3 px-6 font-bold text-gray-200 transition-colors duration-200 ease-in-out peer-checked:bg-gray-200 peer-checked:text-gray-900 peer-checked:border-gray-200 "> Check me3 </label>
   <input type="checkbox" id="choose-me4" class="hidden peer" />
  <label for="choose-me4" class="select-none cursor-pointer rounded-lg border-2 border-gray-200
   py-3 px-6 font-bold text-gray-200 transition-colors duration-200 ease-in-out peer-checked:bg-gray-200 peer-checked:text-gray-900 peer-checked:border-gray-200 "> Check me4 </label>
</div>
